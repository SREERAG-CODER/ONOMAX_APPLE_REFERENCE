...
export default function Footer() {
  return (
    <footer className="w-full bg-[#111] border-t border-white/10 pt-16 pb-8 overflow-hidden z-10 relative">
      <div className="mx-auto max-w-[1200px] px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-5 space-y-4">
            <Link href="#" className="flex items-center gap-2 group">
              <Image
                ...
                height={28}
                priority
                className="w-7 h-7 transition-transform duration-500 group-hover:rotate-[60deg]"
              />
          ...
          <div className="col-span-2 space-y-3">
            <h5 className="text-[10px] font-mono tracking-wider text-white/40 uppercase">Platform</h5>
          ...
          <div className="col-span-2 space-y-3">
            <h5 className="text-[10px] font-mono tracking-wider text-white/40 uppercase">Company</h5>
            <ul className="space-y-2 text-xs font-semibold text-white/60">
          ...
          <div className="col-span-3 space-y-3">
            <h5 className="text-[10px] font-mono tracking-wider text-white/40 uppercase">Legal</h5>
            <ul className="space-y-2 text-xs font-semibold text-white/60">
